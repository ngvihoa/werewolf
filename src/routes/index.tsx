...
function phaseLabel(phase: PlayerGameView['phase']) {
  return (
    {
      NIGHT: 'Ban đêm',
...
function queueStepLabel(step: GameState['queue'][number]['step']) {
  return (
    {
...
function queueStatusLabel(status: GameState['queue'][number]['status']) {
  return (
    {
      PENDING: 'Chờ',
      ACTIVE: 'Đang gọi',
